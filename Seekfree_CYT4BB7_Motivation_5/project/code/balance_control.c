...
void balance_cascade_init_test(void)
{
    ...
    pitch_balance_cascade.posture_value.mechanical_zero = 4.0f;      // 机械零点初始化为 0°
    ...
    pitch_balance_cascade.angular_speed_cycle.out_max       = 8000;   // 角速度环输出上限
...
//
//    pitch_balance_cascade.speed_cycle.p             = 52.0f;    // 速度环 P
