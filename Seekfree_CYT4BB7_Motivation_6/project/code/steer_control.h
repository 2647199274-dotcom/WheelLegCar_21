...
// 左上舵机
#define STEER_1_PWM        (TCPWM_CH31_P10_3)    // 舵机控制引脚
#define STEER_1_FRE        (300)                 // 舵机控制频率
#define STEER_1_DIR        (1)                   // 舵机旋转方向(车体升高方向)
#define STEER_1_CENTER     (4350)                // 舵机中心值(初始保持位置, 大腿水平)

// 右上舵机
#define STEER_2_PWM        (TCPWM_CH57_P17_4)    // 舵机控制引脚
#define STEER_2_FRE        (300)                 // 舵机控制频率
#define STEER_2_DIR        (-1)                  // 舵机旋转方向(车体升高方向)
#define STEER_2_CENTER     (4500)                // 舵机中心值(初始保持位置, 大腿水平)

// 左下舵机
#define STEER_3_PWM        (TCPWM_CH58_P17_3)    // 舵机控制引脚
#define STEER_3_FRE        (300)                 // 舵机控制频率
#define STEER_3_DIR        (-1)                  // 舵机旋转方向(车体升高方向)
#define STEER_3_CENTER     (4650)                // 舵机中心值(初始保持位置, 大腿水平)

// 右下舵机
#define STEER_4_PWM        (TCPWM_CH30_P10_2)    // 舵机控制引脚
