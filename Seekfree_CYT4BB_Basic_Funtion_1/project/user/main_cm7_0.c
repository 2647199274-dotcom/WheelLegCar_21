 ...
 int main(void)
{
    ...
    tft180_show_string(10,0,"ready go");
	...
	tft180_show_int(10,25,GYRO_DATA_X,6);        
        tft180_show_int(10,40,GYRO_DATA_Y,6);  
	tft180_show_int(10,55,GYRO_DATA_Z,6);  
	tft180_show_int(10,70,ACC_DATA_X,6);  
	tft180_show_int(10,85,ACC_DATA_Y,6);  
	tft180_show_int(10,100,ACC_DATA_Z,6);  
	system_delay_ms(30);
